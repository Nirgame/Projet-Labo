...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" 
    ...
    <body>
        ...
        <div class="mx-auto" style="width: 400px;">
            ...
            <ul class="list-group">
            <li class="list-group-item list-group-item-danger"> Etes vous sur de vouloir supprimer ses cartes ? Attention les utilisateurs étant relié à ses cartes n'auront plus de cartes attitrées</li>
            <?php for($i=0; $i< $ID;$i++){ ?>        
            <li class="list-group-item">
            <input type="hidden" id="Suppr" name="Suppr<?php echo $i; ?>" value="<?php echo $id[$i][0] ?>">  numéro : <?php echo $num[$i][0] ?> série : <?php echo $identifiant[$i][0] ?>
            </li>
                    <?php } 
                    ?>
