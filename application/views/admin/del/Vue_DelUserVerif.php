...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" 
    ...
    <body>
        ...
        <div class="mx-auto" style="width: 400px;">
            <form action="<?=site_url("/C_Administrator/viewDelUser")?>" method="POST" >
            <ul class="list-group">
            <li class="list-group-item list-group-item-danger"> Etes vous sur de vouloir supprimer ses utilisateurs ainsi que leur historique d'accès au local ?</li>
            <?php for($i=0; $i< $ID;$i++){ ?>        
            <li class="list-group-item">
            <input type="hidden" id="Suppr" name="Suppr<?php echo $i; ?>" value="<?php echo $id[$i][0] ?>"> <?php echo $nom[$i][0] ?> <?php echo $prenom[$i][0] ?>
            </li>
                    <?php } 
                    ?>
