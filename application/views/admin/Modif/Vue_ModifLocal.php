...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" 
    ...
    <body>
        ...
        <h1> Modifier Local </h1>
        <div class="but">
        <div class="mx-auto" style="width: 400px;">
            <form action="<?=site_url("/C_Administrator/viewModifLocal")?>" method="post" >
            <select class="form-select" aria-label="multiple select example" name="LocalModif">
                <option selected>Veuillez sélectionnez un local</option>
                    <?php for($i=1; $i< $ID;$i++){ ?>
                       <option value= <?php echo $IDLocal[$i][0] ?> > <?php echo $Nom[$i][0] ?> </option> <?php
                    } ?>
                </select>
